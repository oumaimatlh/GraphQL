...
<div class="dashboard">
    <header class="header">
        ...
        <div style="display: flex; align-items: center; gap: 10px;">
            ...
            <div style="display: inline-flex; align-items: center; gap: 6px; padding: 4px 12px; background: rgba(168, 85, 247, 0.12); border: 1px solid rgba(168, 85, 247, 0.35); border-radius: 20px;  font-family: 'Plus Jakarta Sans', sans-serif; font-size: 11px; font-weight: 700;  color: #a855f7;  letter-spacing: 0.5px; box-shadow: 0 0 12px rgba(168, 85, 247, 0.2);backdrop-filter: blur(4px);">
                <span>${cohort}</span>
            </div>
        </div>
